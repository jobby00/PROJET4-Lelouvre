 ...
 * @ORM\Entity(repositoryClass="JD\LelouvreBundle\Repository\BilletsRepository")
 */
class Billets {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="JD\LelouvreBundle\Entity\Reservation", inversedBy="billets")
     ...
     * Set reservation
     *
     * @param \JD\LelouvreBundle\Entity\Reservation $reservation
     *
     * @return Billets
     */
    public function setReservation(\JD\LelouvreBundle\Entity\Reservation $reservation)
    {
     ...
     * Get reservation
     *
     * @return \JD\LelouvreBundle\Entity\Reservation
     */
